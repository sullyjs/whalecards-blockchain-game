(function() {
  ...
  function EnemyWave(params) {
    ...
    function Lib() {
      var lib = {
          1: "whale dolphin octopus sea rainbow pond blue river waves crypto blockchain dolphin sperm whale porpoise squid narwhal toothed whale bluewhale plankton rorqual krill humpback whale killer whale beluga whale shark fish mammal cetacea baleen cetartiodactyla whaling".split(" "),
          2: "blowhole hulk giant artiodactyl heavyweight beaked whale international whaling commission hippopotamus monodontidae physeteridae ziphiidae baleen whale cetacean species whaler sheep orca beluga cattle animal humpback beached pig endangered bowhead turtle minke bluefin balaenopteridae seabird balaenidae blubber kogiidae bottlenose herring animal dolphins whale graywhale pelican cow delphinidae moby".split(" "),
          3: "ocean oceanic seafaring oceangoing seagoing shipboard offshore overseas oversea subocean oceans waters seawater seabed coast seaward maritime undersea marine vessel lake seashore water navy naval strait submarine ship waterway seafarers saltwater beach seaway mautical boat ".split(" "),
          4: "mariners seamen tide deep-sea suboceanic shore starfish overboard sailors navies pond marina seaside seaman lakes straits ferry seabird sail fish marines sailor seafood expanse waterborne maritimes".split(" "),
        5: "inherit function includes bourbon normalize angular explorer section ternary twitter overflow absolute postcss invalid viewbox content sublime session display background compile bracket backbone boolean codepen dreamhire contains standup".split(" "),
          6: "fisherman marinas mediterranean puddle aguas vastness baltic salt shipping navigation marin pool drain".split(" ")
      };
      return lib;
    }
